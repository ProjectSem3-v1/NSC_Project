(function ($) {
	...
	$(".label-time").click(function () {
		$(".label-time").removeClass("label-time-active")
		$(this).addClass("label-time-active")
	})
/*=============================================
	=    		 Preloader			      =
=============================================*/
...
/*=============================================
	=    	 Slider Range Active  	         =
=============================================*/
$("#amountMax").val() == 0 ? $("#amountMax").val(10000000) : ''
$("#slider-range").slider({
	range: true,
	min: 0,
	max: 10000000,
	...
	$("#amount").val($("#amountMin").val() + "đ - " + $("#amountMax").val() +"đ");
